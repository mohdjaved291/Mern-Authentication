import { Alert, AlertIcon, Container, Flex, Link, Spinner, Text, VStack, Link as ChakraLink } from "@chakra-ui/react";
                    ...
                    isPending ? <Spinner /> : <VStack align={"center"} spacing={6}>
                        ...
                        </Alert>
                        {
                            isError && <Text color={"gray.400"}>
                                ...
                                <ChakraLink as={Link} to="/password/forgot/register" replace>
                                    Get a new link
                                </ChakraLink>
                            </Text>
                        }
